...
$experience = [
    [
      ...
      'start' => 'Jan 2021',
      'end' => 'Current',
      'description' => "Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
              sunt hic.",
    ],
    [
      ...
      'start' => 'Dec 2019',
      'end' => 'Jan 2021',
      'description' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit
              sunt hic.',
    ],
    [
      ...
      'start' => 'Dec 2017',
      'end' => 'Dec 2019',
      'description' => 'Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
    ],
    [
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?= $experience[$i]["position"]; ?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]["start"];?> -
                <?php if ($experience[$i]["end"] == "Current"): ?>
                <span class="w3-tag w3-teal w3-round">Current</span>
                <?php else: echo $experience[$i]["end"]?>
                <?php endif; ?></h6>
